...
INTERVAL="${1:-60}"
LOG_FILE="user_data/logs/freqtrade-revo-v13914f2-bybit-dynamic-watch-promote.log"
DB_FILE="user_data/tradesv3_revo_v13914f2_bybit_dynamic_watch_promote.dryrun.sqlite"
RUNTIME_DIR="/home/fusion_omega/revo_adaptive/user_data/revo_alpha/runtime/bybit"
...
while true; do
  ...
  docker ps --format "table {{.Names}}\t{{.Status}}\t{{.Image}}" \
    | grep -E "revo_freqtrade_f2_bybit_dynamic_paper|revo_binance_flow_collector|revo_freqtrade_e3b_binance_dynamic_paper" || true
...
db = Path("user_data/tradesv3_revo_v13914f2_bybit_dynamic_watch_promote.dryrun.sqlite")
...
PY
  ...
  docker logs --tail=40 revo_freqtrade_f2_bybit_dynamic_paper 2>&1 || true
